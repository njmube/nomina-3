 ...
 * @author Ususario
 */
public class Afps extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Afp a");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 666, Short.MAX_VALUE))
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Afps.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Afps.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Afps.this.newButtonActionPerformed(evt);
            }
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.udec.modelo.Afp a = new com.udec.modelo.Afp();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.udec.modelo.Afp> merged = new ArrayList<com.udec.modelo.Afp>(list.size());
            for (com.udec.modelo.Afp a : list) {
    ...
    private java.util.List<com.udec.modelo.Afp> list;
